...
```bash
# macOS
LMLIGHT_BASE_URL=https://github.com/lmlight-app/dist_v3/releases/latest/download \
...
# Windows
$env:LMLIGHT_BASE_URL="https://github.com/lmlight-app/dist_v3/releases/latest/download"
